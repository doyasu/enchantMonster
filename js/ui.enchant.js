 ...
 * @type {Object}
 */
enchant.ui = { assets: ['./images/ui.enchant/pad.png', './images/ui.enchant/apad.png', './images/ui.enchant/icon0.png', './images/ui.enchant/font0.png'] };
...
enchant.ui.Pad = enchant.Class.create(enchant.Sprite, {
    ...
    initialize: function() {
        ...
        var image = core.assets['./images/ui.enchant/pad.png'];
...
enchant.ui.APad = enchant.Class.create(enchant.Group, {
    ...
    initialize: function(mode) {
        var core = enchant.Core.instance;
        var image = core.assets['./images/ui.enchant/apad.png'];
...
enchant.ui.MutableText = enchant.Class.create(enchant.Sprite, {
    ...
    setText: function(txt) {
        ...
        for (i = 0; i < txt.length; i++) {
            ...
            this.image.draw(enchant.Game.instance.assets['./images/ui.enchant/font0.png'],
...
enchant.ui.LifeLabel = enchant.Class.create(enchant.Group, {
    ...
    initialize: function(x, y, maxlife) {
        ...
        for (var i = 0; i < this._maxlife; i++) {
            ...
            this.heart[i].image = enchant.Game.instance.assets['./images/ui.enchant/icon0.png'];
